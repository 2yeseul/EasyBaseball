						...
						<div class="col-12">
							<div class="card shadow">
								<div class="card-body" style="color: black;">
									<div class="mb-3">
										<h3>
											<strong>선수 기록 검색</strong>
										</h3>
									</div>

									<form class="form-control-user" method="get" action="stats.do">
										<div class="row gtr-uniform">
											
												<div class="autocomplete col-sm-4 mb-2">
													<h5>타자 이름</h5>
													<input type="text"
														class="form-control col-form-label-lg bg-white"
														name="batterName">
												</div>
												...
												<div class="autocomplete col-sm-4 mb-2">
													...
													<div class="col-12 col-form-label-lg">
