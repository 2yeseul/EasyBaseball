					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false"> <span
								class="mr-2 d-none d-lg-inline text-gray-600"> <%=userNickname%> </span> <img
								class="img-profile rounded-circle" src="css/<%=userTeam%>.png">
						...
						<div class="col-12">
							<div class="card shadow">
								...
								<div class="card-body" style="color: black;">
									...
									<form method="get" action="resultChoice.jsp">
										<div class="mb-3">
											<div class="mb-2">

												<button type="submit" name="selectTeam" value="<%=leftValue%>"
													class="btn btn-success btn-circle btn-sm"
													onclick="overClick()">
													<i class="fas fa-check" style="padding-right: 2px;"></i>
												</button>
										...
										<div>
											<div class="mb-2">
												...
												<button type="submit" name="selectTeam" value="<%=rightValue %>"
													class="btn btn-success btn-circle btn-sm"
													onclick="overClick()">
													<i class="fas fa-check" style="padding-right: 2px;"></i>
												</button>
